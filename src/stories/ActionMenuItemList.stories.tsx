...
const exampleItems: ActionMenuItemListProps['items'] = [
  ...
  { id: '2', icon: <AddShoppingCartIcon />, text: 'Item 2', price: '$25', description: 'Description' },
  { id: '3', icon: <AddShoppingCartIcon />, text: 'Item 3', price: '$50', tag: 'My Tag' },
];
...
export default {
  ...
  argTypes: {
    items: {
      description: 'An array of ActionMenuItemProps objects with an id property.',
...
const Template: StoryFn<typeof ActionMenuItemList> = (args: ActionMenuItemListProps) => <ActionMenuItemList {...args} />;
