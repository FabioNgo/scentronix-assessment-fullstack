...
import { StyleCloseButton, StyledButton, StyledWrapper } from '@/components/ActionMenu/ActionMenu.styles';
...
export function ActionMenu({
  ...
  return <StyledWrapper>
    <ActionMenuModal items={items} position={'top'} isOpen={isOpen}>
      {!isOpen && (
        <StyledButton variant={'contained'} startIcon={buttonIcon} onClick={() => setIsOpen(true)}>
          {buttonText}
        </StyledButton>)}
      {isOpen &&
